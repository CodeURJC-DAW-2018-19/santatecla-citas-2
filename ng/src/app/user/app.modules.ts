...
@NgModule({
    ...
    declarations: [AppComponent, QuoteDetailComponent, QuoteListComponent, QuoteFormComponent, LoginComponent],
    bootstrap: [AppComponent],
    providers: [QuoteService, LoginService, TopicService,UserService,
